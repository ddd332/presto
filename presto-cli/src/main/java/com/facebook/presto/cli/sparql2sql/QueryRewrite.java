...
public class QueryRewrite {
    ...
    String sql;
    String rewriteSql;
    Map<String, Pair<Integer, String>> tablepair;
    ...
    private boolean checkFrom(){
        ...
        Map<String, Pair<Integer, String>> targets = getTableFromMysql();
    ...
    */
    ...
    private Map<String, Pair<Integer, String>> getTableFromMysql(){
        if(!connection.open())
            connection.openConnection();
        Map<String, Pair<Integer, String>> tables = new HashMap<>();
        try{
