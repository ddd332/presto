        ...
        extends PlanOptimizer
{
            ...
            extends PlanNodeRewriter<Void>
    {
        ...
        {
            // call defaultRewrite to skip the invocation of node rewriter, no more recursive calls.
        ...
        {
            PlanNode source = planRewriter.rewrite(node.getSource(), null);
            // if source is MaterializeSampleNode, make a TopNNode as its source. Otherwise just stop the optimization
            if (source instanceof MaterializeSampleNode) {
